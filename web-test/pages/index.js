...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const elevenlabsApiKey = typeof window !== 'undefined' && window.CONFIG?.ELEVENLABS_API_KEY || 'YOUR_ELEVENLABS_API_KEY';
    ...
    const callArgueAPI = async (question) => {
        ...
        const response = await fetch('/api/argue', {
            ...
            body: JSON.stringify({
                ...
                userApiKey: typeof window !== 'undefined' && window.CONFIG?.OPENAI_API_KEY
            }),
        });
